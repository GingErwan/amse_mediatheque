              ...
              children: [
                Column(
                  children: [
                      ...
                      children: [
                        ...
                        Column(mainAxisAlignment: MainAxisAlignment.center,
                          ...
                          Container(
                            ...
                            Text("Note", style: TextStyle(color: Colors.amber, fontSize: 15)),
                            RatingBar.builder(
                               initialRating: 3,
                                minRating: 1,
                    ...
                    Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text("AUTEUR", style: TextStyle(color: Colors.grey, fontSize: 25)),
                        Text(media.description),
                        Container(height: 50, child: Divider(color: Colors.blueGrey, thickness: 1)),
                        Text("A PROPOS", style: TextStyle(color: Colors.grey, fontSize: 20)),
                        Text(media.synopsis),
                      ],
                    ),
                  ],
...
class MediaModel {
  ...
  // Constructor
  MediaModel({this.imageUrl, this.title, this.description, this.synopsis}){like = false;}
}
